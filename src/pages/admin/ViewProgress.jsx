...
const ViewProgress = () => {
  ...
  useEffect(() => {
    const fetchProgressData = async () => {
      try {
        const response = await fetch('https://freshire-backend.onrender.com/api/contact-updates');
    ...
    try {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          const response = await fetch(`https://freshire-backend.onrender.com/api/contact-updates/${id}/view`, {
            method: 'PATCH'
          });
